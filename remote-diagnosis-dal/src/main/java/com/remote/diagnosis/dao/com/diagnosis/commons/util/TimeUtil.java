...
public final class TimeUtil extends DateUtils {
    ...
    /**
     * 日期格式：yyyyMMdd，如20130812=2013�?8�?12�?
     */
    public static final String PATTERN_YYYYMMDD = "yyyyMMdd";
    /**
     * 日期格式：yyMMdd，如130812=2013�?8�?12�?
     */
    public static final String PATTERN_YYMMDD = "yyMMdd";
    /**
     * 日期格式：yyyyMMddHHmmss，如20130812092030=2013�?8�?12�?9�?20�?30�?
     */
    public static final String PATTERN_YYYYMMDDHHMMSS = "yyyyMMddHHmmss";
    /**
     * 日期格式：HHmmss，如092030=9�?20�?30�?
     */
     ...
     * 
     * @return 当前日期时间yyyyMMddHHmmss格式字符�?
     */
    ...
    /**
     * 获取当前系统日期时间的格式化字符�?,默认采用yyyyMMddHHmmss格式
     * 
     * @param pattern
     *            格式化字符串
     * @return 表示当前系统日期时间的格式化字符�?
     */
     ...
     * assertEquals(&quot;20130301&quot;, TimeUtil.daysOffset(&quot;20130228&quot;, null, 1));// 2�?
    ...
    public static final String daysOffset(String srcDate, String pattern,
        ...
        try {
            Date before = parseDateStrictly(srcDate, pattern);// 解析成日期类�?
